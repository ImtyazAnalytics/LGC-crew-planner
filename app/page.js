...
export default function Home() {
  ...
  return (
    <main>
      <header className="topbar flowTopbar">
        <div className="flowHeaderInner">
          <img
            src="/lgc-global-logo.png"
            alt="LGC Global"
            className="flowHeaderLogo"
          />

          <div className="flowHeaderTitle">CREW PLANNING PORTAL</div>

          <div className="headerActions">
            <button className="installAppBtn" onClick={installApp}>Install App</button>
                    ...
                    {crews.filter(c=>c.active!==false).map(c => (
                      <tr key={c.id}>
                        ...
                        {lookAheadDates.map((date) => {
                          ...
                          return (
                            <td key={date} className={`${raw ? "lookBusyCell" : ""} ${past ? "pastDateCell" : ""} ${isWeekendDate(date) ? "weekendCell" : ""}`}>
                              {raw ? (
                                <div className={`cellBusy detailedCell ${past ? "historyCell" : ""}`}>
                                  <b className={["Crew Called Off","No Work","Cancelled","Off"].includes(raw.status) ? "historyStatus" : ""}>{historyStatusLabel(raw)}</b>
                                  ...
                                  <button className="miniEdit" onClick={() => setEditingAssignment(raw)} title="View or edit this assignment">{past ? "View / Edit" : "Edit"}</button>
                                </div>
                              ) : past ? (
